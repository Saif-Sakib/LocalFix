-- LocalFix Database Schema for Jobs
-- Save as: database/migrations/005_create_jobs_table.sql
...
, CONSTRAINT fk_jobs_issue FOREIGN KEY (issue_id) REFERENCES issues(issue_id) -- RESTRICT is default
, CONSTRAINT fk_jobs_location FOREIGN KEY (location_id) REFERENCES locations(location_id) -- RESTRICT is default
, CONSTRAINT fk_jobs_status FOREIGN KEY (status_id) REFERENCES job_status(status_id) -- RESTRICT is default
...
, CONSTRAINT chk_jobs_deadline CHECK (deadline >= created_at)
);
