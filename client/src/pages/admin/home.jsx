                ...
                <div className="activity-list">
                    <div className="activity-item">
                        ...
                        <div className="activity-content">
                            <p><strong>New worker application</strong> submitted for electrical issues</p>
                    ...
                    <div className="activity-item">
                        ...
                        <div className="activity-content">
                            <p><strong>Issue resolved</strong> - Street light repair completed</p>
                            <span className="activity-time">15 minutes ago</span>
                        </div>
                        <button 
                            className="activity-action"
                            onClick={() => navigate('/admin?tab=review-problems')}
                        >
                            Review
                        </button>
                    </div>
                    <div className="activity-item">
                        <div className="activity-icon reported">📋</div>
                        <div className="activity-content">
                            <p><strong>New issue reported</strong> - Pothole on Main Street</p>
                            <span className="activity-time">1 hour ago</span>
                        </div>
                        <button 
                            className="activity-action"
                            onClick={() => navigate('/admin?tab=issues')}
                        >
                            View
                        </button>
                    </div>
                    <div className="activity-item">
                        ...
                        <div className="activity-content">
                            <p><strong>New citizen registered</strong> - John Smith joined the platform</p>
